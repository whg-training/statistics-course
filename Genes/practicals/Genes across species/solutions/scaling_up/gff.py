...
class GFF:
    def __init__( self, file ):
        self.data = parse_gff3_to_dataframe( file )
        # Fix PlasmoDB data
        self.biotype
        self.sequences = parse_sequences_from_gff_metadata( file )

    def genes( self ):
        return self.data[ self.data['type'] == 'gene' ]

    def transcripts( self ):
        return self.data[ self.data['type'] == 'transcript' ]

    def exons( self ):
        return self.data[ self.data['type'] == 'exon' ]
