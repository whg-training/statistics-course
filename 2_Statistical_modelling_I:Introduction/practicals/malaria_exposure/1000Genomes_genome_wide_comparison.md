...
The implication of above paper, which was published in the journal Science, is that the rs60822373 'C' allele is likely under positive selection due to malaria.  The table above is consistent with this, because (although some forms of malaria have been widespread) the highest burden of mortality due to malaria is found in sub-Saharan Africa.  If rs60822373 were malaria-protective, this might lead to the pattern above.
